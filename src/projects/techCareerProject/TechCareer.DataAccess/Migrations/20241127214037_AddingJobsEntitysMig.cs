...
{
    /// <inheritdoc />
    public partial class AddingJobsEntitysMig : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypOfWork", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_YearsOfExperience", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Jobs_TypOfWork",
                        column: x => x.TypeOfWork,
                        principalTable: "TypOfWork",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Jobs_WorkPlace",
                        column: x => x.WorkPlace,
                        principalTable: "WorkPlace",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Jobs_YearsOfExperience",
                        column: x => x.YearsOfExperience,
                        principalTable: "YearsOfExperience",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Jobs_TypeOfWork",
                table: "Jobs",
                column: "TypeOfWork");

            migrationBuilder.CreateIndex(
                name: "IX_Jobs_WorkPlace",
                table: "Jobs",
                column: "WorkPlace");

            migrationBuilder.CreateIndex(
                name: "IX_Jobs_YearsOfExperience",
                table: "Jobs",
